            ...
            <div className="container mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-start">
                    <div className="space-y-8">
                        ...
                        <div className="flex items-start gap-4 group">
                            ...
                            <div className="flex-1">
                                ...
                                <p className="text-sm sm:text-base text-gray-600 leading-relaxed">
                                    Discover our signature <strong>Celsius collection</strong>. Find the long-lasting fragrance that defines your personality.
                                </p>
                            </div>
                        </div>
                        ...
                        <div className="flex items-start gap-4 group">
                            ...
                            <div className="flex-1">
                                ...
                                <p className="text-sm sm:text-base text-gray-600 leading-relaxed">
                                    Pick from premium full-size bottles or travel packs—customized to suit your luxury fragrance journey.
                                </p>
                            </div>
                        </div>
                        <div className="border-t border-gray-300 ml-8"></div>
                        ...
                        <div className="flex items-start gap-4 group">
                            ...
                            <div className="flex-1">
                                ...
                                <p className="text-sm sm:text-base text-gray-600 leading-relaxed">
                                    Join the 7th Heaven Club. Build your network and unlock exclusive rewards with every purchase.
                                </p>
                            </div>
                        </div>
                        <div className="border-t border-gray-300 ml-8"></div>
                        ...
                        <div className="flex items-start gap-4 group">
                            ...
                            <div className="flex-1">
                                ...
                                <p className="text-sm sm:text-base text-gray-600 leading-relaxed">
                                    Create your personal Celsius lineup—luxury scents made with the world's best oils.
                                </p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="relative bg-white rounded-2xl shadow-xl p-8 sm:p-10 lg:p-12 border-t-4 border-[#E6B422] mt-8 lg:mt-0">
                        ...
                        <div className="absolute bottom-0 right-0 w-32 h-32 bg-[#E6B422] opacity-10 rounded-tl-full"></div>
                    </div>
                </div>
                ...
                <div className="text-center mt-12 md:mt-16">
                    <a 
                        ...
                        className="inline-block bg-[#E6B422] text-white font-semibold text-base sm:text-lg px-8 py-3 sm:px-10 sm:py-4 shadow-lg hover:bg-[#25252b] transition-all duration-300 hover:scale-105"
                    >
                        Start Your Journey
                    </a>
                </div>
