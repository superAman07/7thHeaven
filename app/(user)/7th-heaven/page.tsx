        ...
        <div className="bg-[#252525] min-h-screen text-white">
            ...
            <div className="relative h-[80vh] flex items-center justify-center overflow-hidden">
                ...
                <div className="relative z-10 text-center px-4">
                    <h1 className="text-5xl md:text-7xl font-serif mb-6 text-[#E6B422]! font-bold!" style={{ fontFamily: '"Cormorant Garamond", serif' }}>7th Heaven Club</h1>
                    ...
                    <div className="flex gap-4 justify-center">
                        <Link href="/login" className="px-8 py-4 bg-[#E6B422] text-black font-bold uppercase tracking-wider hover:bg-white transition-colors">
                            Join The Club
                        </Link>
